...
# ── Winning config from Task 4 (Models/results/inv4.log) ──
WINNING_INIT_METHOD = 'xavier'
WINNING_SEED = 41
WINNING_EPOCHS = 255
...
HP['patience'] = WINNING_EPOCHS + 10  # unused when track_best=False, kept for clarity
